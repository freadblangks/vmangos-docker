...
CREATE DATABASE IF NOT EXISTS fusiongen DEFAULT CHARSET utf8 COLLATE utf8_general_ci;


create user 'fusiongen'@'localhost' identified by 'fusiongen';
SET PASSWORD FOR 'fusiongen'@'localhost' = PASSWORD('fusiongen');
grant all on fusiongen.* to fusiongen@'localhost' with grant option;
flush privileges;
